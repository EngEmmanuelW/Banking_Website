...
/*---------*Learn more Button*  Button scrolling to the next page--------*/
btnScrollTo.addEventListener('click', function (e) {
  //To display the viewport coordinates
  const s1coords = section1.getBoundingClientRect();
  /*setion1 is the target*/
  section1.scrollIntoView({ behavior: 'smooth' });
});

/*----------Smooth scrolling upon Page navigation-----*/
...
const stickyNav = function (entries) {
  const [entry] = entries;//Distructuring
